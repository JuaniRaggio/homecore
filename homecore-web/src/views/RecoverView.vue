...
.auth-logo {
  width: 56px; height: 56px; background: var(--hc-accent); border-radius: var(--hc-radius-lg);
  display: flex; align-items: center; justify-content: center;
  font-weight: 700; font-size: var(--hc-font-size-xl); margin: 0 auto var(--hc-space-md); color: white;
}
